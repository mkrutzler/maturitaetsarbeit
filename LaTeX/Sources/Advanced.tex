...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{Assets/Ticket-Currency.pdf}
...
Another benefit comes with the ticket inflation or deflation operation, which can only be used by the owner of the currency.
This is the case, because it involves creating or destroying tickets. 
